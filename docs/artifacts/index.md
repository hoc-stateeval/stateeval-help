...
Artifacts should demonstrate professional practice. Common examples:

| Type | Examples |
|------|----------|
| **Planning** | Lesson plans, unit plans, curriculum maps |
| **Student Work** | Samples showing student learning, assessment results |
| **Professional Growth** | PD certificates, conference notes, collaboration documentation |
| **Communication** | Parent newsletters, meeting agendas, team communications |
| **Reflection** | Goal progress documentation, self-evaluation notes |
