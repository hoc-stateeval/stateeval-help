...
Some evidence collections allow you to attach artifacts directly within them (embedded artifacts). Unlike global artifacts, embedded artifacts must be **shared** before the containing evidence collection is submitted — otherwise they won't be included in the published evidence.
